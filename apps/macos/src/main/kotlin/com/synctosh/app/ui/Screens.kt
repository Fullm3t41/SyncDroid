            ...
            item {
                val accessCard: @Composable () -> Unit = {
                    ExpandableInfoCard(
                        ...
                        summary = "SyncTosh only reads folders you explicitly approve",
                        expanded = explanationExpanded,
                        onToggle = { explanationExpanded = !explanationExpanded },
                    ) {
                        Text(
                            "macOS asks for access once. SyncTosh then provides its own file browser beneath the approved location and remembers that permission securely.",
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                        )
                    }
