...
class MeshStoreTest {
    ...
    fun createdMeshRoundTripsThroughAndroidBundleFormat() {
        val directory = Files.createTempDirectory("synctosh-store-test")
        val signer = signer()
    ...
    fun tamperedChatMessageIsRejected() {
        val directory = Files.createTempDirectory("synctosh-chat-test")
        val signer = signer()
    ...
    fun importsLegacyAndroidCreatorThroughAJoinedOfferingDevice() {
        val directory = Files.createTempDirectory("synctosh-android-compat-test")
        val creator = signer()
    ...
    fun rejectsPairingFromADeviceRemovedFromTheMesh() {
        val directory = Files.createTempDirectory("synctosh-removed-peer-test")
        val creator = signer()
    ...
    fun androidFolderAnnouncementArrivesPendingAndCanBeConfigured() {
        val directory = Files.createTempDirectory("synctosh-folder-import-test")
        val signer = signer()
