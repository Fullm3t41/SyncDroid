...
class StableSessionTest {
    ...
    fun pairedPeersAuthenticateAndCompleteMetadataOnlySession() = runBlocking {
        val directory = Files.createTempDirectory("synctosh-session-test")
    ...
    private fun memoryIdentity(alias: String): MacDeviceIdentity {
        val path = java.nio.file.Files.createTempDirectory("synctosh-session-identity").resolve("identity.p12")
