...
class CrossPlatformProtocolFixtureTest {
    ...
    @Test
    fun androidDomainObjectsMatchGoldenPayloads() {
        val time = fixture.required("chat.createdAtMillis").toLong()
        val chat = MeshChatMessage(
            fixture.required("chat.eventId"),
            fixture.required("chat.groupId"),
            fixture.required("chat.authorDeviceId"),
            fixture.required("chat.body"),
            time,
            "",
        )
        assertEquals(fixture.required("chat.payloadHex"), chat.canonicalPayload().fixtureHex())
        assertEquals(true, chat.hasValidMessageId())

        val membership = MembershipEvent(
            fixture.required("membership.eventId"),
            fixture.required("chat.groupId"),
            MembershipEventType.valueOf(fixture.required("membership.eventType")),
            fixture.required("membership.subjectDeviceId"),
            fixture.required("membership.subjectDisplayName"),
            fixture.required("membership.subjectPublicKeyBase64"),
            fixture.required("chat.authorDeviceId"),
        ...
        assertEquals(true, membership.hasValidEventId())

        val folder = FolderAnnouncement(
            fixture.required("folder.eventId"),
            fixture.required("chat.groupId"),
            fixture.required("folder.folderId"),
            fixture.required("folder.displayName"),
        ...
        assertEquals(true, folder.hasValidEventId())
    }
}
