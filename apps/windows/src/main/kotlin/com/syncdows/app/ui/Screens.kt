    ...
    Column(verticalArrangement = Arrangement.spacedBy(9.dp)) {
        ...
        peers.sortedBy { it.name.lowercase() }.forEach { peer ->
            ...
            SwipeToDismissBox(
                ...
                Surface(color = MaterialTheme.colorScheme.surface, shape = androidx.compose.foundation.shape.RoundedCornerShape(14.dp)) {
                ...
                val about: @Composable () -> Unit = {
                    SettingsCard {
                        SettingsActionRow(
                            ...
                            detail = "Local-first · version 0.1.0",
                            onClick = { onFeatureRequested("About SyncDows") },
                        )
                    }
                }
                if (wide) {
